...
class Thread {
  ...
  public:
    ...
    void SetPriority(int priority) { Thread::priority = priority; }

  private:
    // some of the private data for this class is listed above
    
    void _Thread(const char* debugName, bool join, int priority); // initialize a Thread
...
// while executing kernel code.
  ...
  public:
    ...
    void SetRetValue(int retValue) { Thread::retValue = retValue; }
    int GetRetValue() { return retValue; }
    void SetId(SpaceId id) { Thread::id = id; }
    SpaceId GetId() { return id; }
    Thread *GetThreadParent() { return threadParent; }
    OpenFileTable *GetOpenFileTable() { return openFileTable; }
